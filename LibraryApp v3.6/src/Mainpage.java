        ...
        biblioteka1.addActionListener(new ActionListener() {
            ...
            panelInfo.add(dojazd, BorderLayout.SOUTH);
                dojazd.addActionListener(new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        int wybor = JOptionPane.showOptionDialog(Mainpage.this, "Do której biblioteki chcesz dojechać?", "Dojazd", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, new String[]{"Galeria Sfera", "Sarni Stok"}, "Tak");
                        if(JOptionPane.YES_OPTION == wybor) {
                            try {
                                Desktop.getDesktop().browse(new URL("https://www.google.com/maps?rlz=1C1ONGR_plPL1090PL1090&gs_lcrp=EgZjaHJvbWUqBwgAEAAYjwIyBwgAEAAYjwIyDQgBEC4YrwEYxwEYgAQyBwgCEAAYgAQyBwgDEAAYgAQyBwgEEAAYgAQyDQgFEC4YrwEYxwEYgAQyBwgGEAAYgAQyBwgHEAAYgAQyBwgIEAAYgATSAQgxNjU5ajBqNKgCALACAA&um=1&ie=UTF-8&fb=1&gl=pl&sa=X&geocode=KR979MHfoRZHMaUy5IaIrO2U&daddr=Mostowa+5,+43-300+Bielsko-Bia%C5%82a").toURI());
                            ...
                            try {
                                Desktop.getDesktop().browse(new URL("https://www.google.com/maps?rlz=1C1ONGR_plPL1090PL1090&gs_lcrp=EgZjaHJvbWUqDQgAEAAY4wIYsQMYgAQyDQgAEAAY4wIYsQMYgAQyEAgBEC4YrwEYxwEYsQMYgAQyBwgCEAAYgAQyBwgDEAAYgAQyDQgEEC4YrwEYxwEYgAQyBwgFEAAYgAQyEAgGEC4YrwEYxwEYgAQYmAUyBwgHEAAYgAQyBwgIEAAYgAQyBwgJEAAYgATSAQgxNDE2ajBqN6gCALACAA&um=1&ie=UTF-8&fb=1&gl=pl&sa=X&geocode=KdtXLertoRZHMUfj3O-c0aMV&daddr=Sarni+Stok+2,+43-300+Bielsko-Bia%C5%82a").toURI());
                            } catch (IOException ex) {
                                throw new RuntimeException(ex);
                            } catch (URISyntaxException ex) {
                                throw new RuntimeException(ex);
